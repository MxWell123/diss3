...
public class PlanovacPrichodZakaznikovTerm2 extends Scheduler {
    ...
    private static final double[] vstupy = {HODINA / 3, HODINA / 6, HODINA / 9, HODINA / 15, HODINA / 17, HODINA / 19,
        HODINA / 14, HODINA / 6, HODINA / 3, HODINA / 4, HODINA / 21, HODINA / 14, HODINA / 19,
        HODINA / 12, HODINA / 5, HODINA / 2, HODINA / 3, HODINA / 3};
